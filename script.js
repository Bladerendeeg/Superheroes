...
// 1a mijn oplossing
const findNames2 = superheroes.map(hero => {
  return hero.name;
})
console.log(findNames2);
// 1 Solution Maak een array van alle superhelden namen 
...
// 2 mijn oplossing
const findWeight = superheroes.filter(hero => {
  return hero.weight < 190;
});
console.log(findWeight.length);
...
const findFirstapp = superheroes.map(hero => hero.first_appearance);
console.log("First appearance:", findFirstapp);
